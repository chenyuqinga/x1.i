/*
 * ************************************************************
 * 文件：ByteUtils.java  模块：voice  项目：X1.I
 * 作者：coiliaspp
...
public class ByteUtils {
     ...
     * @return
     */
    public static byte[] charToByte2Invert(char c) {
        byte[] arr = new byte[2];
        arr[0] = (byte) (c & 0xff);
        arr[1] = (byte) ((c & 0xff00) >> 8);
        return arr;
    }
     ...
     * @return
     */
    public static byte[] shortToByte2Invert(Short s) {
        byte[] arr = new byte[2];
        arr[0] = (byte) (s & 0xff);
        arr[1] = (byte) ((s & 0xff00) >> 8);
        return arr;
    }
    ...
    public static int byte4ToInt(byte[] arr) {
        ...
        return (int) (((arr[0] & 0xff) << 24) | ((arr[1] & 0xff) << 16) | ((arr[2] & 0xff) << 8) |
                      ((arr[3] & 0xff)));
    }
