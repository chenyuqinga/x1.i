...
public interface RetrofitService {
     ...
     */
    @POST("v2/apply_token")
    Observable<UploadRecipeToken> getUploadRecipeTokenOnLine(@Body RequestBody body, @Header("Access-Token") String header
     ...
     */
    @POST("v2/apply_token")
    Observable<UploadRecipeToken> getUploadRecipeTokenTest(@Body RequestBody body, @Header("Access-Token") String header
            , @Header("X-Device") String deviceId);
     ...
     */
    @POST(ServerUrl.RECIPES_LIST_URL)
    Observable<Response<Recipe>> getUploadRecipeListOnline(@Body RequestBody body, @Header("Access-Token") String header
            , @Header("X-Device") String deviceId);
     ...
     */
    @POST(ServerUrl.RECIPES_LIST_URL_TEST)
    Observable<Response<Recipe>> getUploadRecipeListTest(@Body RequestBody body, @Header("Access-Token") String header
            , @Header("X-Device") String deviceId);
    ...
    Observable<Response> deleteUploadRecipeTest(@Path("id") String id, @Header("Access-Token") String token
            , @Header("X-Device") String deviceId);
    ...
    Observable<DeviceSubQR> getDeviceSubQROnline(@Path("deviceId") String deviceId, @Header("Access-Token") String
            header);
     ...
     */
    @GET(ServerUrl.SUB_QR)
    Observable<DeviceSubQR> getDeviceSubQRTest(@Path("deviceId") String deviceId, @Header("Access-Token") String
            header);
     ...
     */
    @POST(ServerUrl.RECIPES_LIST_URL_TEST)
    Observable<Response<Recipe>> getRecipeByIdTest(@Body RequestBody body, @Header("Access-Token") String header
            , @Header("X-Device") String deviceId);
