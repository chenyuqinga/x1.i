...
/** 
 * DAO for table "DREADY_STEP".
*/
public class DReadyStepDao extends AbstractDao<DReadyStep, Long> {

    public static final String TABLENAME = "DREADY_STEP";

    /**
     * Properties of entity DReadyStep.<br/>
    ...
    private Query<DReadyStep> dRecipe_ReadyStepsQuery;

    public DReadyStepDao(DaoConfig config) {
        super(config);
    }
    
    public DReadyStepDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DREADY_STEP\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DREADY_STEP\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DReadyStep entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DReadyStep entity) {
        stmt.clearBindings();
    ...
    @Override
    public DReadyStep readEntity(Cursor cursor, int offset) {
        DReadyStep entity = new DReadyStep( //
    ...
    @Override
    public void readEntity(Cursor cursor, DReadyStep entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DReadyStep entity, long rowId) {
        entity.set_id(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(DReadyStep entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(DReadyStep entity) {
    ...
    /** Internal query to resolve the "readySteps" to-many relationship of DRecipe. */
    public List<DReadyStep> _queryDRecipe_ReadySteps(String id) {
        synchronized (this) {
            if (dRecipe_ReadyStepsQuery == null) {
                QueryBuilder<DReadyStep> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Id.eq(null));
                dRecipe_ReadyStepsQuery = queryBuilder.build();
            }
        }
        Query<DReadyStep> query = dRecipe_ReadyStepsQuery.forCurrentThread();
