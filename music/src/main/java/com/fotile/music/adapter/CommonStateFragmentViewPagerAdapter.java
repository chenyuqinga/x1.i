...
/**
 * 文件名称：CommonStateFragmentViewPagerAdapter
 * 创建时间：2019/6/15 16:10
 * 文件作者：yaohx
 * 功能描述：ViewPager滑动时，Fragment不会被回收，依旧保存上一次显示的状态
 */
public class CommonStateFragmentViewPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
    // 每个Fragment对应一个Page
    ...
    public CommonStateFragmentViewPagerAdapter(FragmentManager fragmentManager, ViewPager viewPager, List<Fragment>
            fragments) {
