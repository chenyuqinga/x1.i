...
public class OtaLoadingView extends View {
     ...
     * 构造函数，初始化前景图片和背景图片
     */
    public OtaLoadingView(Context context) {
        super(context);
        mContext = context;
        init();
    }

    public OtaLoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        this.attrs = attrs;
        init();
    ...
    private void init() {
        int drawableResId = R.mipmap.ic_loading;
