package com.fotile.common.util.log;
...
public class LogUtil {
     ...
     */
    static LogSave logSave = new LogSave();

    public static void LOG_SCREEN(String obj) {
        if (isDebug) {
            if (null != obj) {
                Log.e("屏保相关ScreenSaverService", obj);
            } else {
                Log.e("屏保相关ScreenSaverService", "null");
            }
        }
    }
    ...
    public static void LOG_STOVE_LINK(String TAG, Object obj) {
        if (isDebug) {
            if (null != obj) {
    ...
    public static void LOG_Notifi(String TAG, Object obj) {
        if (isDebug) {
            if (null != obj) {
    ...
    public static void LOG_BIND(String tag, Object obj) {
        if (isDebug) {
            if (null != obj) {
                Log.e("----扫码绑定----" + tag, obj.toString());
            } else {
                Log.e("----扫码绑定----" + tag, "null");
            }
        }
    ...
    public static void LOG_JAZ1(String tag, Object obj) {
        if (isDebug) {
            if (null != obj) {
                Log.e("----JAZ1灶具----" + tag, obj.toString());
            } else {
                Log.e("----JAZ1灶具----" + tag, "null");
            }
        }
    }
    ...
    public static void LOG_BLE_MUSIC(String tag, Object obj) {
        if (isDebug) {
            if (null != obj) {
                Log.e("----蓝牙音箱----" + tag, obj.toString());
            } else {
                Log.e("----蓝牙音箱----" + tag, "null");
            }
        }
