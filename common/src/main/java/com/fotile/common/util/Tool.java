...
public class Tool {
    ...
    public static void setCurrentBrightDark(Context context) {
        try {
            ...
            Settings.System.putInt(context.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS, currentBright *
                    50 / 100);
     ...
     * @return
     */
    public static String pidName(Context context) {
     ...
     * 获取本地固件包版本
     */
    public static String getLocalSysVersion(Context context) {
...
//    }
    ...
    public static long getNetTime(Context context){
        try {
            //中国科学院国家授时中心
            String str = "http://time.tianqi.com";
            ...
            LogUtil.LOGE("==============网络时间",time +"  " + urlDate);
