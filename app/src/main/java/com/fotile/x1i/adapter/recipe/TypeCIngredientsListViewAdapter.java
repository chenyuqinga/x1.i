...
public class TypeCIngredientsListViewAdapter extends BaseAdapter {
    private Context context;
    private List<CIngredient> list;

    public TypeCIngredientsListViewAdapter(Context context, List<CIngredient> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CIngredient cIngredient = list.get(position);
        String materialName = cIngredient.getName();
        String materialQuantity = cIngredient.getUnit();
