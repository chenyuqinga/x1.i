...
/**
 * 文件名称：MinorIngredientsListViewAdapter
 * 创建时间：2017/8/7
 * 文件作者：zhaoqingjing
 * 功能描述：Minor Ingredients of recipe list view adapter
 */

public class MinorIngredientsListViewAdapter extends BaseAdapter {
    private Context context;
    private List<MinorIngredient> list;

    public MinorIngredientsListViewAdapter(Context context, List<MinorIngredient> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MinorIngredient minorIngredient = list.get(position);
