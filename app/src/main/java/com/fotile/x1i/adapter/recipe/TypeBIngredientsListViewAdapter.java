...
public class TypeBIngredientsListViewAdapter extends BaseAdapter {
    private Context context;
    private List<BIngredient> list;

    public TypeBIngredientsListViewAdapter(Context context, List<BIngredient> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BIngredient bIngredient = list.get(position);
        String materialName = bIngredient.getName();
        String materialQuantity = bIngredient.getUnit();
