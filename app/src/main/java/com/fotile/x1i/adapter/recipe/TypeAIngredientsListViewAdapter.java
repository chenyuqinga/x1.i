...
public class TypeAIngredientsListViewAdapter extends BaseAdapter {
    private Context context;
    private List<AIngredient> list;

    public TypeAIngredientsListViewAdapter(Context context, List<AIngredient> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AIngredient aIngredient = list.get(position);
        String materialName = aIngredient.getName();
        String materialQuantity = aIngredient.getUnit();
